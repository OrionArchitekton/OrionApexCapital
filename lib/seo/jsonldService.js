...
export function generateServicesItemListJsonLd() {
  const services = [
    ...
    },
    {
      ...
      description: "Strategic consulting and implementation outcomes across finance, operations, and digital assets. Design, development, SEO, CRO, and trading enablement services.",
