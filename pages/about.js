...
export default function About({ missionVision }) {
  return (
    <Layout 
      title="About"
      description="Orion Apex Capital is a modern holding company where human intuition + algorithmic precision drive disciplined growth. We govern independent subsidiaries across AI, media, and trading R&D."
      url="/about"
    >
          ...
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div>
                    <p className="text-xs uppercase tracking-[0.35em] text-brand-copper pulse-dot">Holding company</p>
              ...
              <p className="text-lg leading-relaxed text-text-muted">
                Orion Apex Capital is a modern holding company where <strong className="text-text-primary">human intuition + algorithmic precision</strong> drive disciplined growth. We govern independent subsidiaries across AI, media, and trading R&D. Cosmocrat serves as our internal operating system - aligning strategy, execution, and governance across the portfolio.
              </p>
      ...
      >
        <Container className="grid gap-6 lg:grid-cols-12">
          {[
            {
              title: "Structure",
              copy: "Ohio HoldCo with siloed operating subsidiaries. Clear intercompany IP & services agreements. No custody, no advice-just governed software, media, and R&D."
            },
            {
              title: "Discipline",
